...
import com.gupao.vip.mic.dubbo.user.dto.CheckAuthRequest;
import com.gupao.vip.mic.dubbo.user.dto.CheckAuthResponse;
...
public class UserCoreService implements IUserCoreService {
    ...
    public UserLoginResponse login(UserLoginRequest userLoginRequest) {
        ...
        try{
            ...
            //ztadd生成token
            jwtTokenService.generatorToken(new JwtInfo(user.getId().toString()));
